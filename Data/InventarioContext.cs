...
public class InventarioContext : DbContext
{
    ...
    private IEnumerable<Producto> InitProducts(){
        List<Producto> products = new List<Producto>(){
            new(){IdProducto=1,IdBase=1,IdContainer=2,Medida=2,Precio=38,UrlImagen="https://holymarket.cl/wp-content/uploads/2022/03/7801610001295-1.png",Existencia=10,Estado=Models.Enums.EstadoCatalogo.Registrado},
            new(){IdProducto=2,IdBase=2,IdContainer=2,Medida=2,Precio=39,UrlImagen="https://docplayer.es/docs-images/109/187608361/images/12-3.jpg",Existencia=5,Estado=Models.Enums.EstadoCatalogo.Registrado},
            new(){IdProducto=3,IdBase=3,IdContainer=2,Medida=2,Precio=39,UrlImagen="http://d2r9epyceweg5n.cloudfront.net/stores/001/160/839/products/005-004-011_fanta-retornable-x-2-lts1-67b8aab041082aa14315884684037152-640-0.jpg",Existencia=13,Estado=Models.Enums.EstadoCatalogo.Registrado}
        };
